...
class Dataset:
    ...
    def _encode_train(self):
        ...
        with open(os.path.join(self.input_dir, "train_embeddings.pkl"), "wb") as f:
    ...
    def _encode_eval(self):
        ...
        with open(os.path.join(self.input_dir, "eval_embeddings.pkl"), "wb") as f:
            pickle.dump(self.eval_data, f)

    def load(self):
        with open(os.path.join(self.input_dir, "eval_embeddings.pkl"), "rb") as f:
            self.eval_data = pickle.load(f)

        with open(os.path.join(self.input_dir, "train_embeddings.pkl"), "rb") as f:
